...
from app.services.models import DeepModelTrainingService as ModelTrainingService
from app.services.models import DeepTrainingConfig as TrainingConfig
from app.services.models import ModelMetrics, ModelType, QlibDataProvider
...
class TestModelTrainingService:
    ...
    def test_prepare_training_data(
        self, service, training_config, sample_features_data
    ):
        """测试训练数据准备"""
