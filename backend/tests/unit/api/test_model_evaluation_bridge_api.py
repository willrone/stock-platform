...
def test_evaluation_report_includes_portfolio_bridge_summary() -> None:
    ...
    bridge_summary = {
        ...
        "tasks": [
            {
                ...
                "stock_contribution_summary": {
                    ...
                    "top_contributors": [{"stock_code": "600036.SH", "total_pnl": 345.6}],
                    "bottom_contributors": [{"stock_code": "601288.SH", "total_pnl": -120.0}],
                },
            }
        ],
        ...
        "cost_vs_gross_gap_rollup": {
            ...
            "largest_cost_gap": {"task_id": "task-1", "gross_minus_net_value_gap": 123.4},
            "best_gross_return": {"task_id": "task-1", "total_return_without_cost": 0.022},
    ...
    official_record_summary = {
        "signal_record": {
            "train": {"dataset_samples": 60, "evaluated_samples": 60, "has_signal_quality": True, "analysis_scope": "train"},
            "validation": {"dataset_samples": 20, "evaluated_samples": 20, "has_signal_quality": True, "analysis_scope": "validation"},
            "test": {"dataset_samples": 20, "evaluated_samples": 18, "has_signal_quality": True, "analysis_scope": "test"},
        },
        "sig_ana_record": {
            "train": {"rank_ic": 0.11},
        ...
        "port_ana_record": {"task_count": 1, "tasks": [{"task_id": "task-1"}], "best_by_total_return": None, "best_by_sharpe": None, "smallest_drawdown": None},
    }

    with patch("app.api.v1.models.SessionLocal") as mock_session_local, patch(
        ...
        mock_session.query.return_value.filter.return_value.first.return_value = model_record
    ...
    assert payload["cost_vs_gross_gap_summary"] == bridge_summary["cost_vs_gross_gap_rollup"]
    assert payload["per_stock_ranking_preference"] == bridge_summary["per_stock_contribution_rollup"]
