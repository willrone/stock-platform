...
class TestStochasticStrategy:
    ...
    def test_strategy_creation(self):
        """测试策略创建"""
        config = {"k_period": 14, "d_period": 3, "oversold": 20, "overbought": 80}
...
class TestMeanReversionStrategy:
    ...
    def test_strategy_creation(self):
        """测试策略创建"""
        config = {"lookback_period": 20, "zscore_threshold": 2.0, "position_size": 0.1}
...
class TestAdvancedStrategyFactory:
    ...
    def test_create_technical_strategy(self):
        ...
        strategy = AdvancedStrategyFactory.create_strategy("cci", {"period": 20})
    ...
    def test_create_factor_strategy(self):
        ...
        strategy = AdvancedStrategyFactory.create_strategy("low_volatility", {})
    ...
    def test_invalid_strategy(self):
        ...
        with pytest.raises(TaskError):
            AdvancedStrategyFactory.create_strategy("invalid_strategy", {})
