...
class TestStrategyFactoryPortfolio:
    ...
    def test_create_portfolio_by_config(self):
        ...
        config = {
            "strategies": [
                ...
                {"name": "macd", "weight": 0.5, "config": {"fast_period": 12}},
            ]
        }
    ...
    def test_portfolio_default_weight(self):
        ...
        config = {
            "strategies": [
                {"name": "rsi", "config": {"rsi_period": 14}},  # 没有指定weight
                {"name": "macd", "config": {"fast_period": 12}},  # 没有指定weight
            ]
        }
    ...
    def test_portfolio_invalid_strategy_name(self):
        """测试无效策略名称"""
        config = {
            "strategies": [{"name": "invalid_strategy", "weight": 1.0, "config": {}}]
        }
    ...
    def test_single_strategy_still_works(self):
        """测试单策略创建仍然正常工作"""
        config = {"rsi_period": 14, "oversold_threshold": 30}
