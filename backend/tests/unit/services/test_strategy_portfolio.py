...
class TestStrategyPortfolio:
    ...
    def test_create_portfolio(self):
        ...
        portfolio = StrategyPortfolio(
            strategies=strategies, weights={"rsi": 0.6, "macd": 0.4}
        )
    ...
    def test_generate_signals(self):
        ...
        portfolio = StrategyPortfolio(
            strategies=strategies, weights={"rsi": 0.5, "macd": 0.5}
        )
        ...
        if signals:
            assert (
                "source_signals" in signals[0].metadata
                or "integration_method" in signals[0].metadata
            )
