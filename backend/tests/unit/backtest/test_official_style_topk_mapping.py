...
def test_derive_official_style_topk_dropout_params(
    pool_size: int, expected: dict[str, int]
) -> None:
    assert derive_official_style_topk_dropout_params(pool_size) == expected


def test_apply_official_style_topk_dropout_params_fills_missing_ranking_parameters() -> (
    None
):
...
def test_apply_official_style_topk_dropout_params_ignores_non_ranking_strategies() -> (
    None
):
    strategy_config = apply_official_style_topk_dropout_params(
...
def test_normalize_task_backtest_strategy_config_applies_official_style_mapping() -> (
    None
):
