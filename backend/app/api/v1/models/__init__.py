...
# 注册评估路由
router.add_api_route("/{model_id}/evaluation-report", get_model_evaluation_report, methods=["GET"])
router.add_api_route("/{model_id}/performance-history", get_model_performance_history, methods=["GET"])
...
router.add_api_route("/{model_id}/dependencies", get_model_dependencies, methods=["GET"])
router.add_api_route("/{model_id}/lifecycle/transition", transition_model_lifecycle, methods=["POST"])
