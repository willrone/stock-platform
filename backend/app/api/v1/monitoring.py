...
from app.services.monitoring.performance_monitor import alert_manager
...
async def get_alert_history(
    ...
    try:
        ...
        for alert in alert_history:
            ...
            stats["severity_distribution"][alert_severity] = stats["severity_distribution"].get(alert_severity, 0) + 1
            
            # 按类型统计
            alert_type_val = alert.get("alert_type", "unknown")
            stats["type_distribution"][alert_type_val] = stats["type_distribution"].get(alert_type_val, 0) + 1
...
@router.post("/alerts/{alert_id}/resolve", response_model=StandardResponse, summary="解决告警")
...
async def get_monitoring_dashboard():
    ...
    try:
        ...
        dashboard_data = {
            ...
            "recent_metrics": recent_metrics[-20:] if recent_metrics else []  # 最近20个指标点
        }
