...
async def create_optimization_task(
    ...
    try:
        ...
        try:
            ...
            # 使用进程池提交任务
            future = process_executor.submit(execute_optimization_task_simple, task.task_id)
...
async def list_optimization_tasks(
    ...
    try:
        ...
        # 过滤出优化任务
        optimization_tasks = [t for t in tasks if t.task_type == TaskType.HYPERPARAMETER_OPTIMIZATION.value]
