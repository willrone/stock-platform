...
class VersionManager:
    ...
    def update_version_info(
        ...
        try:
            ...
            logger.info(f"版本信息已更新: {version_info['version']}, 股票数: {stock_count}, 指标数: {version_info['indicator_count']}")
    ...
    def check_version_consistency(
        ...
        try:
            ...
            if expected_date_range:
                ...
                if (actual_range.get('start') != expected_date_range.get('start') or
                    actual_range.get('end') != expected_date_range.get('end')):
                    issues.append(f"日期范围不一致: 期望 {expected_date_range}, 实际 {actual_range}")
