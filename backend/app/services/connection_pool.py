...
class HTTPConnectionPool:
        ...
        **kwargs
        ...
        try:
            ...
            stats.average_response_time_ms = (
                (stats.average_response_time_ms * (stats.successful_requests - 1) + response_time) /
    ...
    async def get_pool_stats(self, pool_name: str = "default") -> ConnectionStats:
        ...
        if pool_name in self._clients:
            ...
            stats.pool_utilization = min(1.0, stats.active_connections / self.config.max_connections)
...
class DatabaseConnectionPool:
    ...
    def __init__(self, database_url: str, config: PoolConfig):
        ...
        if database_url.startswith(('postgresql+asyncpg', 'mysql+aiomysql', 'sqlite+aiosqlite')):
    ...
    def _update_stats(self):
        ...
        try:
            ...
            self.stats.idle_connections = pool_status.pool_size - pool_status.checked_out
    ...
    def get_pool_info(self) -> Dict[str, Any]:
        ...
        try:
            ...
            return {
                ...
                'utilization': pool_status.checked_out / self.config.max_connections if self.config.max_connections > 0 else 0,
                'stats': self.stats
            }
