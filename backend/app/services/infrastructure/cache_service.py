    ...
    def put(self, key: str, value: Any, ttl: Optional[float] = None) -> bool:
        ...
        with self._lock:
            ...
            while (
                ...
                or self._memory_usage + size_bytes > self.memory_limit_bytes
            ):
                if not self._cache:
                    break
                self._evict_lru()
        ...
        with self._lock:
            if name not in self._caches:
                config = self._default_configs.get(
                    name, {"max_size": 100, "default_ttl": 600, "memory_limit_mb": 50}
                )
    ...
    def get_global_stats(self) -> Dict[str, Any]:
        ...
        with self._lock:
            ...
            for name, cache in self._caches.items():
                ...
                total_stats["total_memory_usage_mb"] += stats.memory_usage_bytes / (
                    1024 * 1024
                )
            ...
            if total_requests > 0:
                total_stats["overall_hit_rate"] = (
                    total_stats["total_hits"] / total_requests
                )
