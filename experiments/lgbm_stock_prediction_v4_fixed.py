...
if __name__ == '__main__':
    ...
    model.save_model('/Users/ronghui/Projects/willrone/experiments/lgbm_model_v4_fixed.txt')
    print("\n模型已保存到: lgbm_model_v4_fixed.txt")
    
    result.to_csv('/Users/ronghui/Projects/willrone/experiments/lgbm_v4_fixed_results.csv', index=False)
