...
if __name__ == '__main__':
    ...
    # 保存模型
    model.save_model('/Users/ronghui/Documents/GitHub/willrone/experiments/lgbm_model_v4.txt')
    print("\n模型已保存到: lgbm_model_v4.txt")
    
    # 保存结果
    result.to_csv('/Users/ronghui/Documents/GitHub/willrone/experiments/lgbm_v4_results.csv', index=False)
